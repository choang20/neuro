...
//    let head_angle_horizontal: [HeadAngleForFrame]
...
//            let stimulus_speed = speeds[index]
...
//        }
//        let min_angle = data.min {(angle1, angle2) in
//            angle1.angle < angle2.angle
//        }!.angle
//        let max_angle = data.max {(angle1, angle2) in
//            angle1.angle < angle2.angle
//        }!.angle
//        return [min_angle * 1.1, 0, max_angle * 1.1].map({Int($0)})
//    }
//    
//    var body: some View {
//        VStack{
...
//}
//
//struct HeadAnglePlot: View {
//    let title: String
//    let data: [HeadAngleForFrame]
//    let n_frames: Int
//    let default_ticks: [Int]
//    @State private var scale_to_fit = false
//    
...
//}
//
//struct HeadAngleForFrame {
//    let frame_index: Int
//    let elapsed: TimeInterval
//    let angle: Float
//}
//
//extension HeadAngleForFrame: Identifiable {
//    var id: String {
//        "\(frame_index)"
//    }
//}
